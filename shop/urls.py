...
from shop.views.contactus import contact_us
# from shop.views.employeeprofile import EmployeeProfilePageView
...
urlpatterns = [
    ...
    # path("employee_profile", EmployeeProfilePageView.as_view(), name="employee_profile")
]