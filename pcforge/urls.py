...
from shop.views.profilepageview import ProfilePageView

from shop.views.database_testing import DatabaseTestingView
...
urlpatterns = [
    ...
    path("database-testing", DatabaseTestingView.as_view(), name="database-testing")  
]